...
type CreateStreamRequest struct {
	...
	ReplicationFactornonISR int32  `protobuf:"varint,6,opt,name=replicationFactornonISR,proto3" json:"replicationFactornonISR,omitempty"`
}
...
func (m *CreateStreamRequest) GetReplicationFactornonISR() int32 {
	if m != nil {
		return m.ReplicationFactornonISR
	}
	return 0
}
...
type SubscribeRequest struct {
	...
	ReadNonISRFollower bool          `protobuf:"varint,7,opt,name=ReadNonISRFollower,json=readNonISRFollower,proto3" json:"ReadNonISRFollower,omitempty"`
}
...
func (m *SubscribeRequest) GetReadNonISRFollower() bool {
	if m != nil {
		return m.ReadNonISRFollower
	}
	return false
}
...
type PartitionMetadata struct {
	...
	Nonisrfollower []string `protobuf:"bytes,5,rep,name=nonisrfollower" json:"nonisrfollower,omitempty"`
}
...
func (m *PartitionMetadata) GetNonisrfollower() []string {
	if m != nil {
		return m.Nonisrfollower
	}
	return nil
}
...
func (m *CreateStreamRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ReplicationFactornonISR != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ReplicationFactornonISR))
	}
	return i, nil
}
...
func (m *PartitionMetadata) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Nonisrfollower) > 0 {
		for _, s := range m.Nonisrfollower {
			dAtA[i] = 0x2a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *CreateStreamRequest) Size() (n int) {
	...
	if m.ReplicationFactornonISR != 0 {
		n += 1 + sovApi(uint64(m.ReplicationFactornonISR))
	}
	return n
}
...
func (m *CreateStreamRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplicationFactornonISR", wireType)
			}
			m.ReplicationFactornonISR = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReplicationFactornonISR |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *SubscribeRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReadNonISRFollower", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *PartitionMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Nonisrfollower", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Nonisrfollower = append(m.Nonisrfollower, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
...
var fileDescriptorApi = []byte{
	...
	,
}
